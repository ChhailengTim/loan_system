            ...
            <b-tabs card>
              <b-tab :title="$t('borrower')" active>
                ...
                <b-row class="mt-5">
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/borrower/photo/${formItem.photo}`"
                        alt="photo"
                        width="150"
                        height="150"
                        rounded
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/borrower/national_id_photo/${formItem.national_id_photo}`"
                        alt="national"
                        width="150"
                        height="150"
                        rounded
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div v-if="$helpers.nullToVoid(formItem.family_book) == ''">
                      <i
                        class="fas fa-image"
                        style="font-size: 150px; color: #a0aec0"
                      ></i>
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/borrower/family_book/${formItem.family_book}`"
                        alt="family_book"
                        width="150"
                        height="150"
                        rounded
                        :id="formItem.family_book"
                      />

                      <b-tooltip
                        :target="formItem.family_book"
                        placement="right"
                        variant="light"
                      >
                        <img
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/borrower/mortgage/${formItem.mortgage}`"
                        alt="mortgage"
                        width="150"
                        height="150"
                        rounded
                  ...
                  <b-col cols="6" md="3" xl="3" class="mt-3">
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/borrower/salary_invoice/${formItem.salary_invoice}`"
                        alt="salary_invoice"
                        width="150"
                        height="150"
                        rounded
              ...
              <b-tab :title="$t('guarantor')">
                <b-row>
                  ...
                  <b-col cols="6">
                    {{ $t("gender") }}:
                    <b v-if="formItem.guarantor_gender == 1">{{
                      $t("male")
                    }}</b>
                    <b v-if="formItem.guarantor_gender == 2">{{
                      $t("female")
                    }}</b>
                  </b-col>
                </b-row>
                ...
                <b-row class="mt-5">
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <label for="">{{ $t("photo") }}</label>
                    <div
                      v-if="$helpers.nullToVoid(formItem.guarantor_photo) == ''"
                    >
                      <i
                        class="fas fa-image"
                        style="font-size: 150px; color: #a0aec0"
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/guarantor/photo/${formItem.guarantor_photo}`"
                        alt="photo"
                        width="150"
                        height="150"
                        rounded
                        :id="formItem.guarantor_photo"
                      />

                      <b-tooltip
                        :target="formItem.guarantor_photo"
                        placement="right"
                        variant="light"
                      >
                        <img
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div
                      v-if="
                        $helpers.nullToVoid(
                          formItem.guarantor_national_photo
                        ) == ''
                      "
                    >
                      <i
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/guarantor/national_id_photo/${formItem.guarantor_national_photo}`"
                        alt="national"
                        width="150"
                        height="150"
                        rounded
                        :id="formItem.guarantor_national_photo"
                      />

                      <b-tooltip
                        :target="formItem.guarantor_national_photo"
                        placement="right"
                        variant="light"
                      >
                        <img
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div
                      v-if="
                        $helpers.nullToVoid(formItem.guarantor_mortgage) == ''
                      "
                    >
                      <i
                        class="fas fa-image"
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/guarantor/mortgage/${formItem.guarantor_mortgage}`"
                        alt="mortgage"
                        width="150"
                        height="150"
                        rounded
                        :id="formItem.guarantor_mortgage"
                      />

                      <b-tooltip
                        :target="formItem.guarantor_mortgage"
                        placement="right"
                        variant="light"
                      >
                        <img
                  ...
                  <b-col cols="6" md="3" xl="3">
                    ...
                    <div
                      v-if="
                        $helpers.nullToVoid(
                          formItem.guarantor_salary_invoice
                        ) == ''
                      "
                    >
                      <i
                    ...
                    <div v-else>
                      <b-img
                        :src="`/images/guarantor/salary_invoice/${formItem.guarantor_salary_invoice}`"
                        alt="salary_invoice"
                        width="150"
                        height="150"
                        rounded
                        :id="formItem.guarantor_salary_invoice"
                      />

                      <b-tooltip
                        :target="formItem.guarantor_salary_invoice"
                        placement="right"
                        variant="light"
                      >
                        <img
